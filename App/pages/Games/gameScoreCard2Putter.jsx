...
{   
    ...
    console.log("here in GameScoreCard2Putter");
    ...
    const handleLocationPress=(location)=>{
       ...
       // console.log(strokescore);
        ...
        var gamestroke = {game_match_stroke_id: 0,
                          ...
                          distance: 0,
                          location: location,
                          isin_putter_length: isInPutterLength,
                          isin_hole: isInhole,
                          status: 'Approved',
    ...
    <View style={[containerStyle]}>
        ...
        <View style={[containerStyle, { flex: 0.3,flexDirection:"col" }]}>
            <TouchableOpacity
                    ...
                    onPress={() => handleLocationPress('InPutter')}
                    >
                    <Text>In Putter Length                      {arrow}</Text>
            </TouchableOpacity>
            <TouchableOpacity
                    style={radioButtonText}
                    onPress={() => handleLocationPress('NotInPutter')}
                    >
                    <Text>Not In Putter Length                  {arrow}</Text>
            </TouchableOpacity>
            <TouchableOpacity
                    style={radioButtonText}
...
export default GameScoreCard2Putter