...
{   const [gameScoreCard, setGameScoreCard] = useState(null);
    ...
    console.log("holefactor first:" + holefactor);
    //setMyGame(params.game);
    const initGameScoreCard = async() =>
    {
        ...
        .then(response => {
            ...
            //console.log("holefactor" + holefactor);
    ...
    {gameScoreCard !== null ? 
        (
            <View style={[containerStyle, { flex: 0.1,flexDirection:"row" }]}>
                <Text style={fancyTextStyle}> {`${gameScoreCard.gameUser.firstName}75%`}</Text>
                <Text style={fancyTextStyle}> Disabled 40% </Text>
            </View>      
        ):
        (
            <View style={[containerStyle, { flex: 0.1,flexDirection:"row" }]}>    
